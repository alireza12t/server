...
// router.post("signup", async(req)).signup = catchAsync(
//   async (req, res, next) => {
...
//     if (err) {
//       logger.error(
//         `The query on User Collection with email ${req.session.email} has some errors: ${err}`
//       );
//       err.statusCode = 500;
//       err.clientCode = 14;
...
//             if (err) {
//               logger.error(
//                 `The save action on User Collection with document ${req.session.email} has some errors: ${err}`
//               );
//               err.statusCode = 500;
//               err.clientCode = 14;
//               err.clientMessage = "در فرآیند تغییر گذرواژه مشکلی پیش آمده است!";
//               err.title = "خطا در سرور";
//               err.messageEnglish =
//                 "Error happened during the changing password!";
//               next(err);
//             } else {
